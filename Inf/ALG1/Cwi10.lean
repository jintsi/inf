...
theorem Zad1a : !![0, 1, 1; 1, 0, 1; 1, 1, 0].det = (2 : ℤ) := rfl

theorem Zad1b : !![1, 0, 0, 1; 0, 2, 0, 1; 1, 0, 1, 1; 1, 1, 0, 1].det = -1 := rfl

open Complex in
theorem Zad1c : !![1, 0, 1+I; 0, 1, I; 1-I, -I, 1].det = -2 := by
...
theorem Zad1h [CommRing R] (x y z : R) :
...
theorem Zad4a {x y z t : ℝ} (h1 : x + 2 * y + 3 * z + 4 * t = 11)
    (h2 : 2 * x + 3 * y + 4 * z + t = 12) (h3 : 3 * x + 4 * y + z + 2 * t = 13)
    (h4 : 4 * x + y + 2 * z + 3 * t = 14) : t = 1 := by grind

theorem Zad4b {x y z t : ℝ} (h1 : 2 * x + 3 * y + 5 * z + 11 * t = 2)
...
open Complex in
theorem ZadD3b : !![1+I, I, 1-I; I, I, 0; 1, 0, 4]⁻¹ =
