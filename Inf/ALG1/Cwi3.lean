...
theorem Zad1b :
    x1 + x2 + 2 * x3 + 3 * x4 = 1 ∧ 3 * x1 + 2 * x2 - x3 - 2 * x4 = 1 ∧ 2 * x1 + 2 * x2 + x3 = 2 ↔
    x1 = -2 * x4 - 1 ∧ x2 = 3 * x4 + 2 ∧ x3 = -2 * x4 := by grind only

theorem Zad1c : 8 * x1 + 6 * x2 + 5 * x3 + 2 * x4 = 21 ∧ 3 * x1 + 3 * x2 + 2 * x3 + x4 = 10 ∧
                  4 * x1 + 2 * x2 + 3 * x3 +     x4 = 8  ∧ 3 * x1 + 5 * x2 +     x3 + x4 = 14 ∧
                  7 * x1 + 4 * x2 + 5 * x3 + 2 * x4 = 18 ↔ False := by grind only
